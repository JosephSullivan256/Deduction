...
var grammar = {
    ...
    {"name": "Proposition", "symbols": ["Proposition$string$1", /[0-9]/], "postprocess": function(d) {return {type:'proposition', subformulas:[], n:parseInt(d[1])}}},
    {"name": "Proposition", "symbols": [{"literal":"p"}, "subnumber"], "postprocess": function(d) {return {type:'proposition', subformulas:[], n:d[1]}}},

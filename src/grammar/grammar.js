...
var grammar = {
    ...
    {"name": "Not", "symbols": [{"literal":"("}, "not", "Formula", {"literal":")"}], "postprocess": function(d) {return {type:'not', d:d[2][0]}}},
    {"name": "And", "symbols": [{"literal":"("}, "Formula", "_", "and", "_", "Formula", {"literal":")"}], "postprocess": function(d) {return {type:'and', left:d[1][0], right:d[5][0]}}},
    {"name": "Or", "symbols": [{"literal":"("}, "Formula", "_", "or", "_", "Formula", {"literal":")"}], "postprocess": function(d) {return {type:'or', left:d[1][0], right:d[5][0]}}},
    {"name": "Implies", "symbols": [{"literal":"("}, "Formula", "_", "implies", "_", "Formula", {"literal":")"}], "postprocess": function(d) {return {type:'implies', left:d[1][0], right:d[5][0]}}},
    ...
    {"name": "Proposition", "symbols": ["Proposition$subexpression$1"], "postprocess": function(d) {return {type:'proposition', n:d[0][1]}}},
    ...
    {"name": "Contradiction", "symbols": ["contradiction"], "postprocess": function(d) {return {type:'contradiction'}}},
